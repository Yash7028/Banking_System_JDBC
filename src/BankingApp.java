...
public class BankingApp {
    ...
    public static void main(String[] args) throws  ClassNotFoundException , SQLException{
        ...
        try{
            ...
            User user = new User(connnection , scanner);
            Accounts accounts = new Accounts(connnection, scanner);
            AccountManager accountManager = new AccountManager(connnection , scanner);
